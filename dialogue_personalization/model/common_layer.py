...
from mltd.tarp import LRLayer, LRLinear, DyLRLinear
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, input_depth, total_key_depth, total_value_depth, output_depth, 
        ...
        if tarp is False:
            ...
            # self.query_linear = LRLinear(input_depth, total_key_depth, rank=4, bias=False, divide_by_rank=False)
            # self.key_linear = LRLinear(input_depth, total_key_depth, rank=4, bias=False, divide_by_rank=False)
            # self.value_linear = LRLinear(input_depth, total_value_depth, rank=4, bias=False, divide_by_rank=False)
            # self.output_linear = LRLinear(total_value_depth, output_depth, rank=4, bias=False, divide_by_rank=False)
